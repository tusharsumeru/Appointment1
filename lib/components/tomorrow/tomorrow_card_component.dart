...
class _TomorrowCardComponentState extends State<TomorrowCardComponent> {
  ...
  List<Map<String, dynamic>> _getEventsForCategory(String categoryKey) {
    if (_tomorrowEvents.isEmpty) return [];

    switch (categoryKey) {
      case 'morning':
      case 'night':
        return _tomorrowEvents.where((event) {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        'Total Events: ${_tomorrowEvents.length}',
                        style: TextStyle(fontSize: 14, color: Colors.grey[600]),
                      ),
                    ],
                  ),
  ...
  Set<String> _getAllSelectableAppointmentIds() {
    ...
    for (final appointment in _tomorrowAppointments) {
