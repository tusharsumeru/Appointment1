...
class _TomorrowScreenState extends State<TomorrowScreen> {
  ...
  final GlobalKey<State<TomorrowCardComponent>> _tomorrowCardKey = GlobalKey<State<TomorrowCardComponent>>();
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          ...
                          final state = _tomorrowCardKey.currentState as dynamic;
