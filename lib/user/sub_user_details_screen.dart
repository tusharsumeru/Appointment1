  ...
  Future<void> _downloadSelectedAsZip() async {
    ...
    try {
      ...
      await Share.shareXFiles(
        ...
        subject: 'Divine Pictures - ${downloadedFiles.length} image${downloadedFiles.length > 1 ? 's' : ''}',
      );
  ...
  Widget _buildFaceMatchImageCard(Map<String, dynamic> imageData) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Top section with info and checkbox
          Padding(
            padding: const EdgeInsets.all(8),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                // Left side: Divine Picture info and Face Match Score
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                        'Divine Picture ${((currentPage - 1) * itemsPerPage) + faceMatchResults.indexOf(imageData) + 1}',
                        style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
                          color: Colors.black87,
