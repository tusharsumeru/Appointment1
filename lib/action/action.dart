...
class ActionService {
  static const String baseUrl =
      'https://580088914e22.ngrok-free.app/api/v3'; // API base URL
    ...
    try {
      ...
      if (response.headers['content-type']?.contains('application/json') == true) {
        ...
        if (response.statusCode == 200 && (data['success'] == true || data['error'] == null)) {
          ...
          return {'success': false, 'message': data['message'] ?? 'Failed to send bulk email'};
        }
      } else {
        // Response is not JSON (probably HTML error page)
      ...
      return {
        'success': false,
        'message': 'Something went wrong while sending bulk email. Please try again.',
      };
    }
  }
